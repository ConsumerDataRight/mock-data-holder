...
namespace CDR.DataHolder.Banking.Repository.Infrastructure
{
    ...
    /// </summary>
    public class BankingDataHolderDatabaseContextDesignTimeFactory : IDesignTimeDbContextFactory<BankingDataHolderDatabaseContext>
	{
		public BankingDataHolderDatabaseContextDesignTimeFactory()
		{
			// A parameter-less constructor is required by the EF Core CLI tools.
		}

		public BankingDataHolderDatabaseContext CreateDbContext(string[] args)
		{
			var options = new DbContextOptionsBuilder<BankingDataHolderDatabaseContext>()
			...
			return new BankingDataHolderDatabaseContext(options);
		}
	}
}
