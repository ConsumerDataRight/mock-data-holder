        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUri = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AccountConcession",
                columns: table => new
                {
                    AccountConcessionId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    AdditionalInfoUri = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountConcession", x => x.AccountConcessionId);
                    table.ForeignKey(
                        name: "FK_AccountConcession_Account_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountPlan", x => x.AccountPlanId);
                    table.ForeignKey(
                        name: "FK_AccountPlan_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountPlan_Plan_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plan",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlanOverviewId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanOverview", x => x.PlanOverviewId);
                    table.ForeignKey(
                        name: "FK_PlanOverview_AccountPlan_AccountPlanId",
                        column: x => x.AccountPlanId,
                        principalTable: "AccountPlan",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServicePointId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AccountPlanId = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    NationalMeteringId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ServicePointClassification = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ServicePointStatus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicePoint", x => x.ServicePointId);
                    table.ForeignKey(
                        name: "FK_ServicePoint_AccountPlan_AccountPlanId",
                        column: x => x.AccountPlanId,
                        principalTable: "AccountPlan",
                        principalColumn: "AccountPlanId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountConcession_AccountId",
                table: "AccountConcession",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountPlan_AccountId",
                table: "AccountPlan",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountPlan_PlanId",
                table: "AccountPlan",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanOverview_AccountPlanId",
                table: "PlanOverview",
                column: "AccountPlanId",
                unique: true,
                filter: "[AccountPlanId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePoint_AccountPlanId",
                table: "ServicePoint",
                column: "AccountPlanId");
