...
using CDR.DataHolder.Shared.Resource.API.Business.Middleware;
...
namespace CDR.DataHolder.Shared.Business
{
    public static class Extensions
    {
        ...
        public static Shared.Business.Models.Links GetLinks(this ControllerBase controller, IConfiguration configuration, int? currentPage = null, int totalPages = 0, int? pageSize = null)
        {
            ...
            if (string.IsNullOrEmpty(resourceBaseUri))
            {
                ...
                {
                    selfLink = ReplaceUriHost(currentUrl, forwardedHosts[0]);
                }
            }
            else
            {
