...
namespace CDR.DataHolder.Repository.Migrations
{
    ...
    partial class EnergyDataHolderDatabaseContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Account", b =>
                {
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.AccountConcession", b =>
                {
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.AccountPlan", b =>
                {
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Customer", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.LogEventsDrService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.LogEventsManageApi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Organisation", b =>
                {
                    b.Property<Guid>("OrganisationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Person", b =>
                {
                    b.Property<Guid>("PersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Plan", b =>
                {
                    b.Property<string>("PlanId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.PlanOverview", b =>
                {
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.ServicePoint", b =>
                {
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Transaction", b =>
                {
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Account", b =>
                {
                    b.HasOne("CDR.DataHolder.Energy.Repository.Entities.Customer", "Customer")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.AccountConcession", b =>
                {
                    b.HasOne("CDR.DataHolder.Energy.Repository.Entities.Account", "Account")
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.AccountPlan", b =>
                {
                    ...
                    b.HasOne("CDR.DataHolder.Energy.Repository.Entities.Plan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.Customer", b =>
                {
                    b.HasOne("CDR.DataHolder.Energy.Repository.Entities.Organisation", "Organisation")
                        .WithOne("Customer")
                        .HasForeignKey("CDR.DataHolder.Energy.Repository.Entities.Customer", "OrganisationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CDR.DataHolder.Energy.Repository.Entities.Person", "Person")
                        .WithOne("Customer")
                        .HasForeignKey("CDR.DataHolder.Energy.Repository.Entities.Customer", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("CDR.DataHolder.Energy.Repository.Entities.PlanOverview", b =>
                {
                    b.HasOne("CDR.DataHolder.Energy.Repository.Entities.AccountPlan", "AccountPlan")
                        .WithOne("PlanOverview")
                        .HasForeignKey("CDR.DataHolder.Energy.Repository.Entities.PlanOverview", "AccountPlanId")
                        .OnDelete(DeleteBehavior.Cascade);
